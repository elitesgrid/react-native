...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, Image, ImageBackground,Alert } from 'react-native';
                        ...
                        <View style={styles.container}>
                            <FlatList
                                ...
                                renderItem={({ item, index }) => (
                                    <TouchableOpacity onPress={() => navToPlayer({ title: item.title, url: item.url })} key={index} style={{ borderColor: "#EEEEEE", backgroundColor: "white", borderWidth: 1, borderRadius: 10, marginVertical: 2.5, marginHorizontal: 2.5, width: "100%" }}>
                                        <View style={{ flex: 1, flexDirection: "row", height: 80, padding: 20 }}>
                                            {/* <Image source={{ uri: item.thumbnail }} resizeMode='stretch' style={{ height: 48, width: 70, marginHorizontal: 5 }} /> */}
                                            <View>
                                                <ImageBackground source={{ uri: item.thumbnail }} resizeMode="stretch" style={{ ...CommonStyles.videoListCardSize, ...{ height: 48, width: 70, marginHorizontal: 5 } }} blurRadius={2}>
                                                    <View style={CommonStyles.overlay}>
                                                        <Image source={imagePaths.PLAY} style={{ ...CommonStyles.playIcon, ...{ height: 25, width: 25 } }} />
                                                    </View>
                                                </ImageBackground>
                                            </View>
