...
import { View, Text, StyleSheet, ToastAndroid,ScrollView, useWindowDimensions, ImageBackground, SafeAreaView, TouchableOpacity, Linking, Platform } from 'react-native';
                ...
                isLoading ?
                    ...
                    (
                        <View style={[styles.container]}>
                            ...
                            <ScrollView>
                                {paperDetail.image !== "" && <View>
                                        <Image
                                            style={{ width: "100%", height: 210 }}
                                            source={{ uri: paperDetail.image }}
                                            defaultSource={imagePaths.DEFAULT_16_9}
                                        ></Image>
                                    </View>
                                }
                                <View style={{ marginHorizontal: 10 }}>
                                    ...
                                    <View>
                                        <HTML contentWidth={windowWidth} source={{ html: paperDetail.short_desc }} />
                                    </View>
                                    <View>
                                        <Text style={{ fontSize: 18, fontWeight: "600", color: "black" }}>{"Cat Syllabus"}</Text>
                                    </View>
                                    <View>
                                        <HTML contentWidth={windowWidth} source={{ html: paperDetail.description }} />
                                    </View>
                                    <View>
