...
const StackNavigator = () => (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
        <Stack.Screen name={navigationStrings.TAB_ROUTES} component={TabRoutes}></Stack.Screen>
        <Stack.Screen name={navigationStrings.MY_PORTAL} component={MyOrder}></Stack.Screen>
        <Stack.Screen name={navigationStrings.CHANGE_PASSWORD} component={ChangePassword}></Stack.Screen>
        <Stack.Screen name={navigationStrings.CONTACT_US} component={ContactUS}></Stack.Screen>
        ...
        <Stack.Screen name={navigationStrings.TEST_INSTRUCTIONS} component={Instructions}></Stack.Screen>
        <Stack.Screen name={navigationStrings.TEST_ATTEMPT} component={AttemptTest}></Stack.Screen>
        <Stack.Screen name={navigationStrings.TEST_WEBVIEW} component={TestWebView}></Stack.Screen>
        <Stack.Screen name={navigationStrings.NOTIFICATION} component={Notification}></Stack.Screen>
        <Stack.Screen name={navigationStrings.FEED_DETAIL} component={FeedDetail}></Stack.Screen>
        <Stack.Screen name={navigationStrings.CREATE_FEED} component={CreateFeed}></Stack.Screen>
        <Stack.Screen name={navigationStrings.C_WEBVIEW} component={C_Webview}></Stack.Screen>
    </Stack.Navigator>
)
