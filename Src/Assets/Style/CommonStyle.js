...
const CommonStyles = StyleSheet.create({
  ...
  courseListCard:{
     borderColor: "#EEEEEE", backgroundColor: "#FFFFFF", borderWidth: 1, borderRadius: 5, marginHorizontal: 5 
  },
  courseListCardSize:{
    width: 246, height: 223
  },
  ...
  flexRowItemCenter:{ display: "flex", flexDirection: "row",alignItems:"center",width:"40%"},
  CourseListIconStyle:{ height: 12, width: 12, marginRight: 5 },
  CourseListPriceSection:{ display: "flex", flexDirection: "row", justifyContent: "space-between",marginTop:10 },
  CourseListPrice:{ color: "#05030D", fontSize: 16, fontWeight: "500" },
  CourseListStrikePrice:{ color: "#071630", fontSize: 13,opacity:0.5,textDecorationLine:"line-through" },
  CourseListDetailButton:{paddingVertical: 5,paddingHorizontal: 8,borderRadius: 4,backgroundColor: Colors.THEME},
  ...
  bottomTabImages:{height:18,width:22},
