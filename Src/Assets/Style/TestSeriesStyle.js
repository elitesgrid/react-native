...
const TestSeriesStyle = StyleSheet.create({
  ...
  //Pallete Design
  pallete_container:{width:"100%",backgroundColor:Colors.WHITE,height:"100%"},
  pallete_header:{flexDirection:"row",borderBottomColor:"black",borderBottomWidth:1,height:60,alignItems:"center"},
  pallete_symbol_card:{flexDirection:"row",alignItems:"center",width:"45%"},
  pallete_symblo_card_image:{height:30,width:30,alignItems:"center",justifyContent:"center",margin:5}
